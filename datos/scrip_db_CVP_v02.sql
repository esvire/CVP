...
CREATE TABLE IF NOT EXISTS `db_CVP`.`tbl_regimen` (
  `id_regimen` INT NOT NULL AUTO_INCREMENT COMMENT 'este campo contiene la clave primaria de la tabla regimen.',
  `fechaInicio` DATE COMMENT 'Este campo contiene la fecha de inicio de dicho regimen.',
  `fechaFinal` DATE COMMENT 'este campo contiene  la fecha final del regimen.',
...
-- ----------------------------------- --
INSERT INTO tbl_usuario(nombre, apellido, documento, direccion, telefono, clave, pregunta, respuesta, estado,tbl_rol_id_rol) 
	VALUES('administrador', 'gerencia', '888', '888', '123cr123', '312123321', 'nombre de equipo?', 'millonarios',1,1); 

-- ----------------------------------- --
--    insertar Parqueadero defoult     --
-- ----------------------------------- --
INSERT INTO tbl_parqueadero(nombre, nit, direccion, telefono,esado) 
...
-- ----------------------------------- --
INSERT INTO tbl_cliente(nombre, apellido,telefono,esado) 
	VALUES('Parqueadero', '#11111111', '000 000 000', 1); 
